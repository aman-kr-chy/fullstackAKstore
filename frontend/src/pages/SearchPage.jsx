...
const SearchPage = () => {
    ...
    // Filter products by keyword (case-insensitive search in name or category)
        ...
        <div className="pb-12">
            ...
            <div className="bg-gradient-to-r from-primary/10 to-transparent p-8 rounded-3xl mb-10 border border-primary/10 relative overflow-hidden">
                <div className="relative z-10">
                    <h1 className="text-4xl font-black mb-3 text-gray-900 tracking-tight">Search Results</h1>
                    <p className="text-gray-600 text-lg">
                        Showing results for <span className="font-bold text-primary">"{keyword}"</span>
                    </p>
                </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4 bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div className="text-sm text-gray-500 font-medium whitespace-nowrap self-start sm:self-center">
                    Found <span className="text-gray-900 font-bold">{filteredProducts.length}</span> results
                </div>
            </div>
            ...
            {filteredProducts.length > 0 ? (
                ...
                >
                    ...
                    <p className="text-gray-500 mb-8 max-w-md">We couldn't find any products matching your search for "{keyword}". Try using different keywords or browsing our categories.</p>
